...
class oldExpertSystem {
    ...
    private function increaseIndex(&$workloadIndex, $attribute) {
        ...
        if ($attribute == "pk" ||
            ...
            $workloadIndex += (100 - $this->inputs[$attribute]);
    ...
    private function denyDichotomy() {
        ...
        if ($this->dichotomy["mv"] == "low" && $this->dichotomy["ef"] != "undefined") {
        ...
        // information
        if ($this->dichotomy["mv"] == "underload" && $this->dichotomy["sd"] == "overload") {

            $this->reasoning .= "<b>Motivation</b> can't infer underload at the same time "
                                . "<b>solve and deciding</b> infers overload<br>";

            $newDichotomy["mv"] = "undefined";
            $newDichotomy["sd"] = "undefined";
        } else if ($this->dichotomy["mv"] == "overload" && $this->dichotomy["sd"] == "underload") {

            $this->reasoning .= "<b>Motivation</b> can't infer overload at the same time "
        ...
        } else if ($this->dichotomy["pk"] == "overload" && $this->dichotomy["sk"] == "underload") {
        ...
        // Deny past knowledge and effort if they have contradictory information
        if ($this->dichotomy["pk"] == "underload" && $this->dichotomy["ef"] == "overload") {
            ...
            $newDichotomy["pk"] = "undefined";
            $newDichotomy["ef"] = "undefined";
        } else if ($this->dichotomy["pk"] == "fittingMinus" && $this->dichotomy["ef"] == "overload") {

            $this->reasoning .= "<b>Past knowledge</b> can't infer fitting minus at the same time "
                                . "<b>effort</b> infers overload<br>";
        ...
        // Deny skills and effort if they have contradictory information
        if ($this->dichotomy["sk"] == "underload" && $this->dichotomy["ef"] == "underload") {
            ...
            $newDichotomy["sk"] = "undefined";
            $newDichotomy["ef"] = "undefined";
        } else if ($this->dichotomy["sk"] == "overload" && $this->dichotomy["ef"] == "overload") {
        ...
        // Deny context bias and psychological stress if they have contradictory information
